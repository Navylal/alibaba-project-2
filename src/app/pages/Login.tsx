      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-muted-foreground">Sign in to your PerfumeShop account</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-3 rounded-lg hover:shadow-lg transition-all duration-300 hover:scale-[1.02]"
            >
              Sign In
            </button>
          </form>
